...
```text
outlook mail auth login
outlook mail auth status

outlook mail address list
outlook mail folder list

outlook mail sync
outlook mail sync --folder FOLDER_ID
outlook mail sync --full

outlook mail search "工事引継"
...
```text
outlook mail address list
outlook mail address test MESSAGE_ID
