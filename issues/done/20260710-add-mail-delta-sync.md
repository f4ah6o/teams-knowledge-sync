...
Created: 2026-07-10
Updated: 2026-07-10
Branch: feat/20260710-mail-delta-sync
...
- 2026-07-10: Mail CLI初回同期の完了を受け、フォルダー単位delta同期の実装へ着手。
- 2026-07-10: `go test -race ./...`、`go vet ./...`、nextLink/deltaLink遷移、削除、token失効、429相当の再試行枯渇、403、フォルダー分離、daemon反復を検証した。Microsoft 365実環境確認は資格情報が必要なため未実施。
- 2026-07-10: Mail delta同期、障害分離、token復旧、daemonの実装と検証が完了したため完了。
